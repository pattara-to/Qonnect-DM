...
<template>
    ...
    <div v-else class="flex flex-col h-auto w-auto">
        ...
        <div class="w-full sm:w-4/5 h-auto transition-all duration-300 mx-auto mt-3">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
                <div class="relative flex flex-col justify-center items-center">
                    ...
                    <div
                        class="absolute inset-0 flex w-[50%] mx-auto items-center justify-center text-white text-xl bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity rounded-md cursor-pointer"
        ...
        <div class="w-full sm:w-4/5 my-2 mx-auto bg-gray-100 rounded-lg text-base transition-all duration-300">
            ...
            <div class="flex flex-wrap w-full h-full justify-around items-center space-y-2 sm:space-y-0 pr-5">
                ...
                <input
                    type="text"
                    class="w-full sm:w-1/4 p-1 pl-2 bg-gray-200 rounded-lg mt-2 sm:mt-0"
            ...
            <div class="overflow-y-scroll h-45 py-3 scrollbar-width:thin">
