...
<template>
    ...
    <div v-else class="flex flex-col w-full px-5">
        ...
        <div
            class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6  min-[1920px]:grid-cols-8 gap-2 sm:gap-4 mb-4"
        >
