        ...
        <transition name="slide">
            ...
            >
                ...
                <div class="relative w-32 h-32 mb-4">
                    <div
                        class="w-32 h-32 rounded-full bg-gray-200 overflow-hidden flex items-center justify-center shadow-md cursor-pointer hover:bg-gray-300"
                    ...
                    <input ref="machinePicInput" type="file" accept="image/*" @change="handleMachinePicChange" class="hidden" />
                </div>
                    ...
                    <div class="flex flex-col w-full">
                        ...
                        <input
                            ...
                            :class="[
                                ...
                                duplicateMacError ? 'border border-red-500 focus:border-red-500' : 'border border-gray-300 focus:border-blue-500',
                            ]"
                            maxlength="20"
